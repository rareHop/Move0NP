...
export default function Footer() {
    return (
        <footer className="py-5 backdrop-blur-3xl mt-8 px-6 md:px-20 lg:px-32">
            <div>
                <h1 className="text-xl font-bold">Move0N<span className="opacity-50">Player</span></h1>
            ...
            <div className="flex gap-3 mt-3">
                <Link target="_blank" className="text-sm opacity-80 font-light underline hover:opacity-100" href="https://gouravl.vercel.app">Portfolio</Link>
